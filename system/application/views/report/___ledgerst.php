...
//			echo "<tr class=\"tr-balance\"><td colspan=6>Opening</td><td>" . convert_amount_dc($cur_balance) . "</td></tr>";
			echo "<tr class=\"tr-balance\"><td colspan=6>Opening</td><td>" . number_format($cur_balance) . "</td></tr>";
		}
...
//		echo "<tr class=\"tr-balance\"><td colspan=6>Closing</td><td>" .  convert_amount_dc($cur_balance) . "</td></tr>";
		echo "<tr class=\"tr-balance\"><td colspan=6>Closing</td><td>" .  number_format($cur_balance) . "</td></tr>";
		echo "</table>";
	}
?>
